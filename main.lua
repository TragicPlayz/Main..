...
if not isfile("/Blizzard/Configs/Quotes.Blizzard") then 
    writefile("/Blizzard/Configs/Quotes.Blizzard", req({ Url = "" }).Body);
end

if not isfile("/Blizzard/Configs/Keybind.Blizzard") then
    writefile("/Blizzard/Configs/Keybind.Blizzard", game:GetService("HttpService"):JSONEncode({
        Key = "RightControl"
    }))
end
